...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An interactive WebGL exploration of diodes — P-N junctions, Shockley equation, Zener, Schottky, LEDs and the engineering trade-offs. With a built-in AI tutor. Made by Anand, ITM Gwalior." },
